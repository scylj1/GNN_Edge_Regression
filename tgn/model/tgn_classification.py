...
class TGN(torch.nn.Module):
    ...
    def compute_edge_probabilities_original(self, source_nodes, destination_nodes, negative_nodes, edge_times,
                                            edge_idxs, n_neighbors=20):
        """
        ...
        """
        n_samples = len(source_nodes)
        source_node_embedding, destination_node_embedding, negative_node_embedding = self.compute_temporal_embeddings_original(
